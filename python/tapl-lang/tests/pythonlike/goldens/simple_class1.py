...
s0.SimplestClass.__call__ = s0.api__tapl.create_function([], s0.SimplestClass_)
...
s0.Circle.area = s0.api__tapl.create_function([s0.Circle_], Circle.area(s0.Circle_))
s0.Circle_.area = s0.api__tapl.create_function([], s0.Circle.area.subject__tapl.result)
