...
s0.tapl_dev.print(s0.tapl_dev.to_string(s0.matrix.accept_matrix_2_3))
s0.tapl_dev.print(s0.tapl_dev.to_string(s0.matrix.sum(2, 2)))
...
s0.tapl_dev.print(s0.matrix.sum(2, 2)(s0.matrix_2_2, s0.matrix_2_2))
s0.tapl_dev.print(s0.matrix.multiply(2, 2, 3)(s0.matrix_2_2, s0.matrix_2_3))
