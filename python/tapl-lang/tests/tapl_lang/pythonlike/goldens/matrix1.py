...
s0.tapl.typing.import_module(s0, ['examples.matrix'])
...
s0.matrix_2_2.values = s0.tapl.typing.create_typed_list(s0.tapl.typing.create_typed_list(s0.Int, s0.Int), s0.tapl.typing.create_typed_list(s0.Int, s0.Int))
s0.matrix_2_3 = s0.matrix.Matrix(2, 3)()
s0.matrix_2_3.values = s0.tapl.typing.create_typed_list(s0.tapl.typing.create_typed_list(s0.Int, s0.Int, s0.Int), s0.tapl.typing.create_typed_list(s0.Int, s0.Int, s0.Int))
