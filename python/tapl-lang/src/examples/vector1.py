...
class Vector(typelib.BaseType):
    ...
    def append(self, value):
        if not typelib.check_type_equality(value, self._element_type):
    ...
    def concat(self, other):
        ...
        if not typelib.check_type_equality(other._element_type, self._element_type):
...
s0.Vector = Vector
s0.Vector_ = typelib.create_function([], )