...
- Read the papers on language design and theory (draft): [θ-Calculus Ground Rules](ground-rules.pdf), [The θ-Calculus](theta-calculus.pdf), [TAPL Framework](tapl-paper.pdf).
