...
$$ (\lambda Add. \lambda Print. Print\ (Add\ 1\ 2))\ AddImpl\ PrintImpl $$

is same as $$ Print\ (Add\ 1\ 2) $$

here are list of predefined functions:
$$
\begin{array}{rcl}
I &\coloneqq& \lambda x.\, x \\[4pt]
B &\coloneqq& \lambda f.\,\lambda g.\,\lambda x.\, f\ (g\ x) \\[4pt]
UnsafeAdd &\coloneqq& \lambda a.\,\lambda b.\, \{a + b\} \\[4pt]
\end{array}
$$
...
Let's create a type safe version of Add function.
$$
\begin{array}{rcl}
Add &\coloneqq& UnsafeAdd{:} (\lambda a.\,\lambda b.\, {G\ \text{`Int'}\ a; G\ \text{`Int'}\ b}) \\[4pt]
\end{array}
$$
...
$$
= (UnsafeAdd{:}(\lambda a.\,\lambda b.\, G\ \text{`Int'}\ a;\ G\ \text{`Int'}\ b))
  \ (1{:}\text{`Int'})\ (2{:}\text{`Int'})
$$
...
$$
= (UnsafeAdd\ 1){:}((\lambda a.\,\lambda b.\, G\ \text{`Int'}\ a;\ G\ \text{`Int'}\ b)\ \text{`Int'})
  \ (2{:}\text{`Int'})
$$
...
$$
= ((UnsafeAdd\ 1)\ 2){:}(((\lambda a.\,\lambda b.\, G\ \text{`Int'}\ a;\ G\ \text{`Int'}\ b)\ \text{`Int'})\ \text{`Int'})
$$
